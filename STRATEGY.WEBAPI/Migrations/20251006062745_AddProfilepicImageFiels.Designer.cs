...
namespace STRATEGY.WEBAPI.Migrations
{
    ...
    [Migration("20251006062745_AddProfilepicImageFiels")]
    partial class AddProfilepicImageFiels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("STRATEGY.CLIENT.Models.AppRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 10, 6, 9, 27, 45, 412, DateTimeKind.Local).AddTicks(6860),
                            RoleName = "Admin",
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 10, 6, 9, 27, 45, 412, DateTimeKind.Local).AddTicks(6861)
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2025, 10, 6, 9, 27, 45, 412, DateTimeKind.Local).AddTicks(6862),
                            RoleName = "User",
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 10, 6, 9, 27, 45, 412, DateTimeKind.Local).AddTicks(6863)
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2025, 10, 6, 9, 27, 45, 412, DateTimeKind.Local).AddTicks(6864),
                            RoleName = "Visitor",
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 10, 6, 9, 27, 45, 412, DateTimeKind.Local).AddTicks(6864)
                        });
                });
            ...
            modelBuilder.Entity("STRATEGY.CLIENT.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DepartmentId = 1,
                            CreateDate = new DateTime(2025, 10, 6, 9, 27, 45, 412, DateTimeKind.Local).AddTicks(6883),
                            DepartmentManager = "Head IT",
                            DepartmentName = "IT Department",
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 10, 6, 9, 27, 45, 412, DateTimeKind.Local).AddTicks(6884)
                        });
                });
            ...
            modelBuilder.Entity("STRATEGY.CLIENT.Models.Permissions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PermissionId = 1,
                            Create = true,
                            CreateDate = new DateTime(2025, 10, 6, 9, 27, 45, 412, DateTimeKind.Local).AddTicks(6721),
                            Delete = true,
                            PermissionName = "Admin",
                            Update = true,
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 10, 6, 9, 27, 45, 412, DateTimeKind.Local).AddTicks(6740)
                        },
                        new
                        {
                            PermissionId = 2,
                            Create = false,
                            CreateDate = new DateTime(2025, 10, 6, 9, 27, 45, 412, DateTimeKind.Local).AddTicks(6741),
                            Delete = false,
                            PermissionName = "User",
                            Update = false,
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 10, 6, 9, 27, 45, 412, DateTimeKind.Local).AddTicks(6742)
                        },
                        new
                        {
                            PermissionId = 3,
                            Create = false,
                            CreateDate = new DateTime(2025, 10, 6, 9, 27, 45, 412, DateTimeKind.Local).AddTicks(6743),
                            Delete = false,
                            PermissionName = "Visitor",
                            Update = false,
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 10, 6, 9, 27, 45, 412, DateTimeKind.Local).AddTicks(6744)
                        });
                });
