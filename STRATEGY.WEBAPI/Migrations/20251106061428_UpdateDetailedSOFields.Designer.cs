...
namespace STRATEGY.WEBAPI.Migrations
{
    ...
    [Migration("20251106061428_UpdateDetailedSOFields")]
    partial class UpdateDetailedSOFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("STRATEGY.CLIENT.Models.AppRoles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(7202),
                            RoleName = "Admin",
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(7204)
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(7206),
                            RoleName = "User",
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(7207)
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(7208),
                            RoleName = "Visitor",
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(7209)
                        },
                        new
                        {
                            Id = 4,
                            CreateDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(7210),
                            RoleName = "Team",
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(7211)
                        },
                        new
                        {
                            Id = 5,
                            CreateDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(7213),
                            RoleName = "Pteam",
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(7214)
                        });
                });
            ...
            modelBuilder.Entity("STRATEGY.CLIENT.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DepartmentId = 1,
                            CreateDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(7248),
                            DepartmentManager = "Head IT",
                            DepartmentName = "IT Department",
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(7250)
                        });
                });
            ...
            modelBuilder.Entity("STRATEGY.CLIENT.Models.DetailedSO", b =>
                {
                    ...
                    b.Property<DateTime>("DetailedGoalScoreDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("DetailedTargetRegistrantName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("STRATEGY.CLIENT.Models.Permissions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PermissionId = 1,
                            Create = true,
                            CreateDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(6923),
                            Delete = true,
                            PermissionName = "Admin",
                            Update = true,
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(6938)
                        },
                        new
                        {
                            PermissionId = 2,
                            Create = true,
                            CreateDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(6940),
                            Delete = true,
                            PermissionName = "User",
                            Update = true,
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(6941)
                        },
                        new
                        {
                            PermissionId = 3,
                            Create = false,
                            CreateDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(6943),
                            Delete = false,
                            PermissionName = "Visitor",
                            Update = false,
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(6944)
                        },
                        new
                        {
                            PermissionId = 4,
                            Create = false,
                            CreateDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(6946),
                            Delete = false,
                            PermissionName = "Team",
                            Update = false,
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(6947)
                        },
                        new
                        {
                            PermissionId = 5,
                            Create = false,
                            CreateDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(6949),
                            Delete = false,
                            PermissionName = "Pteam",
                            Update = false,
                            UpdatedBy = 0,
                            UpdatedDate = new DateTime(2025, 11, 6, 9, 14, 27, 623, DateTimeKind.Local).AddTicks(6949)
                        });
                });
            ...
            modelBuilder.Entity("STRATEGY.CLIENT.Models.Plan", b =>
                {
                    ...
                    b.Property<bool>("DetailedStrategicObjectivesVisibility")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("StrategicObjectivesVisibility")
                        .HasColumnType("bit");
